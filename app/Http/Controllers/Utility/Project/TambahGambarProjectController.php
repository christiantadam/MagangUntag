...
class TambahGambarProjectController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Utility.Project.TambahGambarProject.TambahGambarProject', compact('divisi', 'access'));
    }


    public function getDataGambarProject(Request $request)
    {
    ...
    public function checkDataProject(Request $request)
    {
    ...
    public function postDataGambarProject(Request $request)
    {
        try {
            ...
            $save = DB::connection('ConnUtility')->table('GAMBAR_PROJECT')->where('Id', $idToCheck);
            $data = [];
            if ($imageBinary3) {
    ...
    public function updateDataGambarProject(Request $request)
    {
        try {
            // dd($request->all());
            $user_input = Auth::user()->NomorUser;
    ...
    public function SelectImagesProject($id, $imageName)
    {
