<div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <input type="hidden" name="" id="IdTeknisi">
            ...
            <div class="modal-body">
                <div class="row-lg-12 mb-2">
                    ...
                    <div class="col-lg-12 d-flex">
                        <select name="teknisi" id="editteknisi" class="form-select" data-live-search="true"
                ...
                <div class="row-lg-12 mb-2">
                    ...
                    <div class="col-lg-12 d-flex">
                        <select name="lokasi" id="editlokasi" class="form-select" data-live-search="true"
